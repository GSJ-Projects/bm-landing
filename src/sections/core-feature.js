...
const data = {
  subTitle: 'Simple Concept. Real Results',
  title: 'Our method resulted in a 67% win rate across 100 backtested NFL games.',
  features: [
    {
      id: 1,
      imgSrc: Briefcase,
      ...
      title: 'Easy to use',
      text:
        'No more crazy algorithms, parlays, or setting your money on fire with daily fantasy games. Our method is simple, easy to use, and it works!',
    },
    {
      id: 2,
      imgSrc: Secure,
      altText: 'Lightning Quick Response',
      title: 'Be Fast. Win Fast.',
      text:
        'Our algorithm uses time tested principles to put you in the drivers seat of your bets.',
    },
  ],
};
